// Temporary examples for testing fluentUI
...
//     const { items, columns, isColumnReorderEnabled,
//       frozenColumnCountFromStart, frozenColumnCountFromEnd } = this.state;
...
//   private _onRenderItemColumn = (item: IExampleItem, index: number,
//     column: IColumn): JSX.Element | string => {
